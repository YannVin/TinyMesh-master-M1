...
public:
  ...
  // Defromations de mesh
  void Warp(const Sphere& s,Vector x);

  // Constructors from core classes
  explicit Mesh(const Box&); //constructeur Mesh du Box
  explicit Mesh(const Disque&, const int&); //constructeur Mesh du Disque
  explicit Mesh(const Cylindre&, const int&); //constructeur Mesh du Cylindre
  explicit Mesh(const Sphere&, const int&); //constructeur Mesh de la Sphere
  explicit Mesh(const Capsule&, const int&); //constructeur Mesh de la Capsule
  explicit Mesh(const Tore&, const int&); //constructeur Mesh du Tore
  explicit Mesh(const HeightField&); //constructeur Mesh du HeightField
  ...
  void RotationZ(double);
  void Homothetie(Vector);
  void Translation(Vector);
...
/*!
\brief Get the number of normales in the geometry.
\return The number of normales in the geometry, in other words the size of normales.
*/
inline int Mesh::Normales() const
{
